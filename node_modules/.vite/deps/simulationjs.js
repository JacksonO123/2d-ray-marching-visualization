...
// node_modules/.pnpm/simulationjs@2.4.7/node_modules/simulationjs/dist/simulation.js
var fps;
var currentMousePos;
var currentMouseEvent;
var validEvents = ["mousemove", "click", "hover", "mouseover", "mouseleave"];
var _setRotation, setRotation_fn, _updateMag, updateMag_fn;
var _Vector = class {
  /**
   * @param {number} x
   * @param {number} y
   ...
   */
  constructor(x, y, r = 0) {
    __privateAdd(this, _setRotation);
    __privateAdd(this, _updateMag);
    this.x = x;
    this.y = y;
    this.mag = pythag(x, y);
    ...
    this.startY = y;
    this.rotation = r;
    __privateMethod(this, _setRotation, setRotation_fn).call(this);
  }
  /**
   * @param {number} deg
   * @returns {Vector}
  ...
  add(v) {
    ...
    this.y += v.x;
    this.startY += v.x;
    __privateMethod(this, _updateMag, updateMag_fn).call(this);
    return this;
  }
  /**
   * @param {number} n
   ...
   */
  clone() {
    return new _Vector(this.x, this.y, this.rotation);
  }
  /**
   * @returns {string}
   */
...
var Vector = _Vector;
_setRotation = new WeakSet();
setRotation_fn = function() {
...
_updateMag = new WeakSet();
updateMag_fn = function() {
  this.mag = pythag(this.x, this.y);
};
var SimulationElement = class {
  /**
   * @param {Point} pos
   * @param {Color} color - optional
   */
...
var _Color = class {
   ...
   */
  toHex() {
    return "#" + __privateMethod(this, _compToHex, compToHex_fn).call(this, this.r) + __privateMethod(this, _compToHex, compToHex_fn).call(this, this.g) + __privateMethod(this, _compToHex, compToHex_fn).call(this, this.b);
  }
};
var Color = _Color;
_compToHex = new WeakSet();
compToHex_fn = function(c) {
  const hex = Math.round(c).toString(16);
  return hex.length == 1 ? "0" + hex : hex;
};
var Point = class extends Vector {
  /**
   * @param {number} x
   * @param {number} y
   */
...
var SceneCollection = class extends SimulationElement {
  /**
...
var _setVector, setVector_fn;
var _Line = class extends SimulationElement {
  /**
   * @param {Point} p1
   * @param {Point} p2
   * @param {Color} color - optional
  ...
  constructor(p1, p2, color = new Color(0, 0, 0), thickness = 1, r = 0) {
    super(p1, color);
    __privateAdd(this, _setVector);
    this.start = p1;
    this.end = p2;
    this.rotation = r;
    this.thickness = thickness;
    __privateMethod(this, _setVector, setVector_fn).call(this);
  }
  /**
   * @returns {Line}
   */
  clone() {
    return new _Line(this.start, this.end, this.thickness, this.color, this.rotation);
  }
  /**
   * @param {Point} p
   * @param {number} t - optional
...
var Line = _Line;
_setVector = new WeakSet();
setVector_fn = function() {
  this.vec = new Vector(this.end.x - this.start.x, this.end.y - this.start.y);
  this.vec.rotateTo(this.rotation);
};
var _checkEvents, checkEvents_fn;
var _Circle = class extends SimulationElement {
  /**
   * @param {Point} pos
   * @param {number} radius
   * @param {Color} color
  ...
  constructor(pos, radius, color) {
    super(pos, color);
    __privateAdd(this, _checkEvents);
    this.radius = radius;
    this.hovering = false;
    this.events = [];
  }
   ...
   */
  clone() {
    return new _Circle(this.pos, this.radius, this.color);
  }
  /**
   * @param {CanvasRenderingContext2D} c
   */
  draw(c) {
    ...
    c.fill();
    c.closePath();
    __privateMethod(this, _checkEvents, checkEvents_fn).call(this);
  }
  /**
   * @param {number} value
   * @param {number} t - optional
...
var Circle = _Circle;
_checkEvents = new WeakSet();
checkEvents_fn = function() {
...
var _setRotation2, setRotation_fn2;
var _Polygon = class extends SimulationElement {
  /***
   * @param {Color} color
   * @param {Point[]} points
   * @param {number} r - optional
  ...
  constructor(pos, points, color, r = 0, offsetPoint = new Point(0, 0)) {
    super(pos, color);
    __privateAdd(this, _setRotation2);
    ...
    this.rotation = r;
    __privateMethod(this, _setRotation2, setRotation_fn2).call(this);
  }
  /**
   * @param {Point[]} points
   */
   ...
   */
  clone() {
    return new _Polygon(this.pos, this.rawPoints, this.color, this.rotation, this.offsetPoint);
  }
  /**
   * @param {number} deg
   */
...
_setRotation2 = new WeakSet();
setRotation_fn2 = function() {
  this.rotation = minimizeRotation(this.rotation);
...
var _setRotation3, setRotation_fn3, _getInitialStartAndMag, getInitialStartAndMag_fn, _getProcessedStartAndMag, getProcessedStartAndMag_fn, _updateDimensions, updateDimensions_fn, _checkEvents2, checkEvents_fn2;
var _Square = class extends SimulationElement {
  /**
   * @param {Point} pos
   * @param {number} width
   * @param {number} height
   ...
   */
  constructor(pos, width, height, color, offsetPoint = new Point(0, 0), rotation2 = 0) {
    super(pos, color);
    __privateAdd(this, _setRotation3);
    __privateAdd(this, _getInitialStartAndMag);
    /**
     * @param {string} component - x or y component of cloned Vector's magnitude
     */
    __privateAdd(this, _getProcessedStartAndMag);
    __privateAdd(this, _updateDimensions);
    __privateAdd(this, _checkEvents2);
    this.width = width;
    this.height = height;
  ...
  updateOffsetPosition(p) {
    ...
    __privateMethod(this, _setRotation3, setRotation_fn3).call(this);
  }
  /**
   * @param {boolean} show
   */
  ...
  draw(c) {
    ...
    __privateMethod(this, _checkEvents2, checkEvents_fn2).call(this);
  }
  /**
   * @param {number} value
   * @param {number} t - optional
  ...
  scale(value, t = 0) {
    ...
    return transitionValues(
      () => {
        ...
        __privateMethod(this, _updateDimensions, updateDimensions_fn).call(this);
      },
      () => {
  ...
  scaleWidth(value, t = 0) {
    let {
      ...
      bottomRightMag,
      bottomLeftMag
    } = __privateMethod(this, _getProcessedStartAndMag, getProcessedStartAndMag_fn).call(this, "x");
    const topRightChange = (topRightMag * value - topRightMag) / (t * fps);
    const topLeftChange = (topLeftMag * value - topLeftMag) / (t * fps);
    const bottomRightChange = (bottomRightMag * value - bottomRightMag) / (t * fps);
    const bottomLeftChange = (bottomLeftMag * value - bottomLeftMag) / (t * fps);
  ...
  scaleHeight(value, t = 0) {
    let {
      ...
      bottomRightMag,
      bottomLeftMag
    } = __privateMethod(this, _getProcessedStartAndMag, getProcessedStartAndMag_fn).call(this, "y");
    const topRightChange = (topRightMag * value - topRightMag) / (t * fps);
    const topLeftChange = (topLeftMag * value - topLeftMag) / (t * fps);
    const bottomRightChange = (bottomRightMag * value - bottomRightMag) / (t * fps);
    const bottomLeftChange = (bottomLeftMag * value - bottomLeftMag) / (t * fps);
   ...
   */
  setWidth(value, t = 0) {
    const scale2 = value / this.width;
    return this.scaleWidth(scale2, t);
  }
  /**
   * @param {number} value
   * @param {number} t - optional
   ...
   */
  setHeight(value, t = 0) {
    const scale2 = value / this.height;
    return this.scaleHeight(scale2, t);
  }
  /**
   * @param {Point} p
   * @returns {boolean}
  ...
  contains(p) {
    ...
    if (cursorVector.x > bottomLeftVector.x && cursorVector.x < topRightVector.x && cursorVector.y > topLeftVector.y && cursorVector.y < bottomLeftVector.y) {
      return true;
    }
    return false;
  }
  ...
  clone() {
    return new _Square(this.pos, this.width, this.height, this.color, this.offsetPoint, rotation);
  }
};
var Square = _Square;
_setRotation3 = new WeakSet();
setRotation_fn3 = function() {
...
_getInitialStartAndMag = new WeakSet();
getInitialStartAndMag_fn = function() {
...
_getProcessedStartAndMag = new WeakSet();
getProcessedStartAndMag_fn = function(component) {
  const startAndMag = __privateMethod(this, _getInitialStartAndMag, getInitialStartAndMag_fn).call(this);
...
_updateDimensions = new WeakSet();
updateDimensions_fn = function() {
  this.height = this.topRight.y + this.bottomRight.y;
  this.width = this.topRight.x + this.topLeft.x;
};
_checkEvents2 = new WeakSet();
checkEvents_fn2 = function() {
  this.events.forEach((event) => {
    const name = event.name;
    switch (name) {
      case "mouseover": {
...
var Arc = class extends SimulationElement {
  /**
   * @param {Point} pos
   * @param {number} radius
   ...
   */
  constructor(pos, radius, startAngle, endAngle, thickness = 1, color, rotation2 = 0, counterClockwise = false) {
    super(pos, color);
    this.radius = radius;
   ...
   * @returns {Promise}
   */
  scaleRadius(scale2, t = 0) {
    const initialRadius = this.radius;
    const scaleChange = (this.radius * scale2 - this.radius) / (t * fps);
    return transitionValues(
      () => {
        this.radius *= scale2;
      },
      ...
      () => {
        this.radius = initialRadius * scale2;
      },
      t
    );
  }
...
function getPixelRatio(c) {
  ...
  const bsr = c.webkitBackingStorePixelRatio || c.mozBackingStorePixelRatio || c.msBackingStorePixelRatio || c.oBackingStorePixelRatio || c.backingStorePixelRatio || 1;
  return dpr / bsr;
}
var _render, render_fn, _resizeCanvas, resizeCanvas_fn;
var Simulation = class {
  ...
  constructor(id, frameRate = 60) {
    ...
    __privateAdd(this, _resizeCanvas);
    fps = frameRate;
    this.scene = [];
    this.idObjs = {};
    this.fitting = false;
    ...
    window.addEventListener("resize", () => __privateMethod(this, _resizeCanvas, resizeCanvas_fn).call(this, this.canvas));
    __privateMethod(this, _resizeCanvas, resizeCanvas_fn).call(this, this.canvas);
    const ctx = this.canvas.getContext("2d");
    ctx.scale(2, 2);
    __privateMethod(this, _render, render_fn).call(this, ctx);
  }
  /**
   * @param {SimulationElement} element
   * @param {String} id - optional
...
render_fn = function(c) {
  ...
  window.requestAnimationFrame(() => __privateMethod(this, _render, render_fn).call(this, c));
};
_resizeCanvas = new WeakSet();
resizeCanvas_fn = function(c) {
...
function minimizeRotation(rotation2) {
  while (rotation2 > 360)
    rotation2 -= 360;
  return rotation2;
}
...
function compare(val1, val2) {
  const nullUndefArr = [null, void 0];
...
//# sourceMappingURL=simulationjs.js.map
